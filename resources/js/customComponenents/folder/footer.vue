        ...
        <div class="md:flex md:justify-between">
          <div class="mb-2 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <span class="self-center text-2xl font-semibold whitespace-nowrap  text-white">Malga</span>
              </a>
              <p class="text-white text-xsm mt-10">
                We worked with over 150 businesses and institution to  <br> install CCTV cameras across South Sudan.
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-white uppercase text-white">Follow us</h2>
                  <ul class=" text-white font-medium">
                      <li class="mb-4">
...
<style>
.custom-shape-divider-top-1738359697 {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
.custom-shape-divider-top-1738359697 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-top-1738359697 .shape-fill {
    fill: #FCE2E2;
}
.footer-separator{
    width: 100%;

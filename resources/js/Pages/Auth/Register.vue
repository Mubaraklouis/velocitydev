...
<template>
    ...
    <GuestLayout>
        <section class="contact-section-wrapper pt-20">
            ...
            <section
                class="contact-wrapper-border contact-info-wrapper relative w-[100%] mx-auto"
            >
                <div
                    class="contact-connect-section connect-border p-4 bg-[#CFACAC] h-60 relative overflow-visible w-[80%] mx-auto rounded-lg shadow-md"
                >
                    <h1 class="font-extrabold text-xl">
                        Connect with
                        <span class="block w-full">the founders</span>
                    </h1>
                    ...
                    <div class="mt-4 flex justify-between relative w-full">
                        <img
                            class="w-20 h-32 object-cover mt-10 z-10"
                            src="/lightning.png"
                            alt=""
                        />
                        <img
                ...
                <div class="contact-form w-[80%] mx-auto">
                    <form @submit.prevent="submit">
                        ...
                        <div class="w-[100%] mt-4">
                            <select
                                id="countries"
                                class="bg-[#CFACAC] opacity-75 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >

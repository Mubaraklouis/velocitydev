...
<h1 class="font-extrabold text-xl">
    Connect with <span class="block w-full">the founders</span>
</h1>

<!-- This is the line -->
<div class="ml-10 mt-2 w-40 h-1 bg-[#000000]"></div>

<div class="mt-4 flex justify-between relative w-full">
    <img class="w-20 h-32 object-cover mt-10 z-10" src="/lightning.png" alt="">
    <img class="w-1/3 h-20 object-cover rounded-lg " src="/contact-py.png" alt="">
    <img class="w-1/3 h-20 object-cover rounded-lg  " src="/contact-im.png" alt="">
</div>
</div>
...
<TextInput
            id="email"
            type="email"
            class="h-12 w-[100%] text-bold text-sm placeholder-gray-800 bg-[#CFACAC] rounded-lg border-none opacity-75 "  placeholder="Enter Email ...."
            v-model="form.email"
            required
        ...
        <TextInput
            id="password"
            type="password"
            class="h-12 w-[100%] text-bold text-sm placeholder-gray-800 bg-[#CFACAC] rounded-lg border-none opacity-75 "  placeholder="Enter Password ...."
            v-model="form.password"
            required
...
<div class="mt-10 grid space-y-4">
                    <button
                        class=" w-[100%] text-bold text-sm placeholder-gray-800 bg-[#CFACAC] rounded-lg border-none opacity-75  h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                        <div class="relative flex items-center space-x-4 justify-center">
                            <img src="https://www.svgrepo.com/show/475656/google-color.svg"
                                class="absolute left-0 w-5" alt="google logo">
                            <span
                                class="block w-max font-semibold tracking-wide text-gray-700 dark:text-white text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Sign In
                                with Google
                            </span>
                        </div>
                    </button>
                    <button
                        ...
                        <div class="relative flex items-center space-x-4 justify-center">
                            ...
                            <span
                                class="block w-max font-semibold tracking-wide text-gray-700 text-sm transition dark:text-white duration-300 group-hover:text-blue-600 sm:text-base">Sign In
                                with Github
                            </span>
                        </div>
                    </button>
